...
namespace EasyPersist.Core.Attributes {
    ...
    public class PersistentPropertyAttribute : Attribute {
        ...
        public PersistentPropertyAttribute(string dbFieldName, DbType dbType, string order, bool lazy)
            : this(dbFieldName, dbType, order) {
            Lazy = lazy;
            }
        ...
        /// </param>
        /// <param name="order">SortOrder when an object is loaded in child collections</param>
        public PersistentPropertyAttribute(string dbFieldName, DbType dbType, SortOrder order)
            : this(dbFieldName, dbType)
        {
            SetOrder(order);
        }
        ...
        /// Usfull for columns with big data inside. 
        /// </param>
        public PersistentPropertyAttribute(string dbFieldName, DbType dbType, bool lazy)
            : this(dbFieldName, dbType) {
            Lazy = lazy;
            }
        /// <summary>
        ...
        /// No needed for strings, persistent objects, and types with new(string) constructor
        /// </param>
        public PersistentPropertyAttribute(string dbFieldName, DbType dbType)
            : this(dbFieldName) {
            DbType = dbType;
            }
        /// <summary>
        ...
        /// Usfull for columns with big data inside. 
        /// </param>
        public PersistentPropertyAttribute(string dbFieldName, bool lazy)
            : this(dbFieldName) {
            Lazy = lazy;
            }
        /// <summary>
        ...
        /// </summary>
        /// <param name="dbFieldName">Column name in the database</param>
        public PersistentPropertyAttribute(string dbFieldName)
        {
            Lazy = false;
